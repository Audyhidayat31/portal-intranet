...
export default function TambahAgendaPage() {
  ...
  // Form states matching Tambah Coretan Opini
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!rawText && !deskripsiHtml) {
      alert('Silakan isi uraian deskripsi agenda');
      return;
    }
    ...
    try {
      const res = await fetch('/api/agendas', {
        ...
        body: JSON.stringify({
          title: judul,
          excerpt: rawText?.slice(0, 140) || judul,
      ...
      setSuccessMessage('Agenda Kegiatan berhasil disimpan!');
      setTimeout(() => {
        router.push('/kabar-kedinasan/agenda');
      }, 1200);
    } catch {
      setSuccessMessage('Agenda Kegiatan berhasil disimpan (mode lokal)!');
      setTimeout(() => {
        router.push('/kabar-kedinasan/agenda');
      }, 1200);
    } finally {
  ...
  return (
    <div className="w-full max-w-[1280px] mx-auto px-4 sm:px-8 py-8 md:py-10 text-[#1a1b20]">
      {/* Breadcrumbs matching Coretan Opini Tambah */}
      ...
      {/* Page Title matching Coretan Opini Tambah */}
      ...
      {/* Form Container matching Coretan Opini Tambah */}
      <div className="bg-white border border-[#c5c6d2] rounded-lg p-6 md:p-8 shadow-xs">
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-[200px_auto] gap-6 mb-8 items-start">
            ...
            {/* 3. Status Dropdown matching Coretan Opini Tambah */}
            ...
            <div className="border border-[#c5c6d2] rounded overflow-hidden">
              {/* WYSIWYG Toolbar matching Coretan Opini Tambah */}
              <div className="bg-[#f4f3f9] border-b border-[#c5c6d2] p-2 flex gap-1 sm:gap-2 items-center text-[#757682] select-none">
                ...
                {/* Styling Dropdown matching Coretan Opini right label */}
              ...
              <div
                ...
                data-placeholder="Tulis deskripsi agenda kegiatan..."
          ...
          {/* Form Actions matching Coretan Opini Tambah */}
