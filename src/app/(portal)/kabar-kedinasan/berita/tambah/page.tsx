...
export default function TambahBeritaPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        setSuccessMessage('Artikel Berita berhasil disimpan!');
        setTimeout(() => {
  ...
  return (
    <div className="w-full max-w-[1280px] mx-auto px-4 sm:px-8 py-8 md:py-10 text-[#1a1b20]">
      {/* Breadcrumbs matching Opini Tambah */}
      ...
      {/* Page Title matching Opini Tambah */}
      ...
      {/* Form Container matching Opini Tambah */}
