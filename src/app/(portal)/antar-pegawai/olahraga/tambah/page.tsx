...
export default function TambahArtikelOlahragaPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!judul.trim()) {
      alert('Nama judul Artikel Olahraga wajib diisi');
      return;
    }
    ...
    const newItem: OlahragaItem = {
      id: `olahraga-custom-${Date.now()}`,
      title: judul,
    ...
    saveStoredOlahraga([newItem, ...currentStored]);
    ...
    setSuccessMessage('Artikel Olahraga berhasil disimpan!');
    setTimeout(() => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-[200px_auto] gap-6 mb-8 items-start">
            ...
            <div>
              <input
                ...
                placeholder="Nama Judul Artikel Olahraga"
            ...
            {/* 3. Status Dropdown placed directly under Tanggal matching Wireframe 3 & previous request */}
            ...
            {/* 5. Gambar Olahraga */}
            <label className="font-semibold text-sm sm:text-base text-[#1a1b20] pt-2">
              Gambar Olahraga <span className="float-right hidden md:inline">:</span>
            </label>
