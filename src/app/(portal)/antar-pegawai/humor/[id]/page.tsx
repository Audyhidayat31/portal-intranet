...
Ternyata buku itu bukan peninggalan bersejarah, melainkan buku catatan milik Pak Andi, pustakawan senior yang terkenal sering ceroboh. Budi tertawa geli dan mengembalikan buku itu ke raknya. Keesokan harinya, ia melihat Pak Andi panik mencari buku catatannya. "Budi, kamu lihat buku pusaka saya tidak? Yang warnanya coklat kusam?" Budi hanya tersenyum simpul sambil menunjuk ke arah Rak 13.`,
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFeedbackMsg('Cerita humor berhasil diperbarui!');
        ...
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4 animate-fadeIn">
          <div className="bg-white rounded-2xl max-w-xl w-full p-6 sm:p-8 shadow-2xl border border-[#c5c6d2] max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleUpdate} className="space-y-4 mt-4">
              <div>
                <label className="block text-xs font-bold text-[#1a1b20] mb-1">Judul Cerita Humor</label>
                <input
                  type="text"
                  required
                  value={editTitle}
              ...
              <div>
                <label className="block text-xs font-bold text-[#1a1b20] mb-1">Uraian Cerita Humor</label>
                <textarea
                  rows={8}
                  required
                  value={editContent}
