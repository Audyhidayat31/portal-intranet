...
export default function TambahTipsGayaHidupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessMessage('Artikel Tips dan Gaya Hidup berhasil disimpan!');
      setTimeout(() => {
        router.push('/antar-pegawai/tips-gaya-hidup');
      }, 1200);
    } catch {
      setSuccessMessage('Artikel Tips dan Gaya Hidup berhasil disimpan (mode lokal)!');
      setTimeout(() => {
        router.push('/antar-pegawai/tips-gaya-hidup');
      }, 1200);
    } finally {
          ...
          <div className="grid grid-cols-1 md:grid-cols-[200px_auto] gap-6 mb-8 items-start">
            ...
            <div>
              <input
                ...
                placeholder="Nama judul Tips dan Gaya Hidup"
