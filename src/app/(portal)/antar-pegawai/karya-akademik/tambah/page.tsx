...
export default function TambahKaryaAkademikPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessMessage('Karya Akademik berhasil disimpan!');
      setTimeout(() => {
        router.push('/antar-pegawai/karya-akademik');
      }, 1200);
    } catch {
      setSuccessMessage('Karya Akademik berhasil disimpan (mode lokal)!');
      setTimeout(() => {
        router.push('/antar-pegawai/karya-akademik');
      }, 1200);
    } finally {
      ...
      <div className="bg-white border border-[#c5c6d2] rounded-lg p-6 md:p-8 shadow-xs">
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-[200px_auto] gap-6 mb-8 items-start">
            ...
            {/* 3. Status Dropdown matching Image 2 */}
            ...
            <label className="font-semibold text-sm sm:text-base text-[#1a1b20] pt-2">
              Gambar Karya Akademik <span className="float-right hidden md:inline">:</span>
            </label>
