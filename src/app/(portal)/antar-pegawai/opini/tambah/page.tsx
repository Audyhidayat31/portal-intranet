...
export default function TambahCoretanOpiniPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessMessage('Artikel Coretan Opini berhasil disimpan!');
      setTimeout(() => {
        router.push('/antar-pegawai/opini');
      }, 1200);
    } catch {
      setSuccessMessage('Artikel Coretan Opini berhasil disimpan (mode lokal)!');
      setTimeout(() => {
        router.push('/antar-pegawai/opini');
      }, 1200);
    } finally {
