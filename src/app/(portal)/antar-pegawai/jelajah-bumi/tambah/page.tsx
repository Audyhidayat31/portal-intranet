...
export default function TambahJelajahBumiPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!judul.trim()) {
      alert('Judul Jelajah Bumi wajib diisi');
      return;
    }
    ...
    try {
      ...
      setSuccessMessage('Artikel Jelajah Bumi berhasil disimpan!');
      setTimeout(() => {
        router.push('/antar-pegawai/jelajah-bumi');
      }, 1200);
    } catch {
      setSuccessMessage('Artikel Jelajah Bumi berhasil disimpan (mode lokal)!');
      setTimeout(() => {
        router.push('/antar-pegawai/jelajah-bumi');
      }, 1200);
    } finally {
          ...
          <div className="grid grid-cols-1 md:grid-cols-[200px_auto] gap-6 mb-8 items-start">
            ...
            <div>
              <input
                ...
                placeholder="Nama judul Jelajah Bumi"
            ...
            <div className="border border-[#c5c6d2] rounded overflow-hidden">
              ...
              <div className="bg-[#f4f3f9] border-b border-[#c5c6d2] p-2 flex gap-1 sm:gap-2 items-center text-[#757682] select-none">
                ...
                {/* Styling Dropdown matching Stitch right label */}
            ...
            {/* 4. Gambar Jelajah Bumi */}
            <label className="font-semibold text-sm sm:text-base text-[#1a1b20] pt-2">
              Gambar Jelajah Bumi <span className="float-right hidden md:inline">:</span>
            </label>
