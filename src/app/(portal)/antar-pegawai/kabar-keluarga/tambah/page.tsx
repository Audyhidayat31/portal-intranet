...
export default function TambahKabarKeluargaPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!judul.trim()) {
      alert('Judul Kabar Keluarga wajib diisi');
      return;
    }
    ...
    try {
      ...
      setSuccessMessage('Warta Kabar Keluarga berhasil disimpan!');
      setTimeout(() => {
        router.push('/antar-pegawai/kabar-keluarga');
      }, 1200);
    } catch {
      setSuccessMessage('Warta Kabar Keluarga berhasil disimpan (mode lokal)!');
      setTimeout(() => {
        router.push('/antar-pegawai/kabar-keluarga');
      }, 1200);
    } finally {
      ...
      <div className="bg-white border border-[#c5c6d2] rounded-lg p-6 md:p-8 shadow-xs">
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-[200px_auto] gap-6 mb-8 items-start">
            ...
            <div>
              <input
                ...
                placeholder="Nama judul Kabar Keluarga"
            ...
            {/* 3. Status Dropdown matching Image 3 */}
            ...
            <div className="border border-[#c5c6d2] rounded overflow-hidden">
              ...
              <div
                ...
                data-placeholder="Tulis deskripsi kabar keluarga..."
            ...
            {/* 5. Gambar Kabar Keluarga */}
            <label className="font-semibold text-sm sm:text-base text-[#1a1b20] pt-2">
              Gambar Kabar Keluarga <span className="float-right hidden md:inline">:</span>
            </label>
          ...
          <div className="flex gap-4 pt-6 mt-8 border-t border-[#c5c6d2]">
            ...
            <Link
              href="/antar-pegawai/kabar-keluarga"
